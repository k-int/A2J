...
public class ASTChoiceType extends SimpleNode {
  ...
  public void getChoiceMembers(ChoiceTypeInfo cti)
  {
    ...
    log.debug("ASTChoiceType::getChoiceMembers");
      ...
      if ( choice_element.which == 1 )
      {
        ...
        if ( element_type_info.which == 1 ) // It's a builtin type
        {
          ...
          if ( bit.which == 6 )
          {
            ...
            {
              log.debug("Unhandled tag number type");
              System.exit(0);
        ...
        if ( element_type_info.which == 1 ) // It's a builtin type
        {
          ...
          switch ( bit.which )
          {
            case 2:  // SetOrSequence
              ...
              log.debug("Creating inline type "+type_name);
              // if ( sos.which == 1 )
              // {
		...
		break;
            ...
            default:
		log.fatal("Unhandled internal type "+bit.which+" "+type_name+" in choice body ("+element_name+")");
                break;
          }
        }
        ...
        log.debug("Adding Choice element "+tag_class+
